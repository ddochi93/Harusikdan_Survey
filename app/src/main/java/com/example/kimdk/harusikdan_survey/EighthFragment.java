...
public class EighthFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final RelativeLayout layout = (RelativeLayout) inflater.inflate(R.layout.fragment_eighth, container, false);
                ...
                switch (compoundButton.getId()) {
                    case R.id.korean:
                        if (toggleButton1.isChecked()) {
                            person.addHate(toggleButton1.getText().toString());
                        } else {
                            person.removeHate(toggleButton1.getText().toString());
                        }
                        break;
                    case R.id.chinese:
                        if (toggleButton2.isChecked()) {
                            person.addHate(toggleButton2.getText().toString());
                        } else {
                            person.removeHate(toggleButton2.getText().toString());
                        }
                        break;
                    case R.id.western:
                        if (toggleButton3.isChecked()) {
                            person.addHate(toggleButton3.getText().toString());
                        } else {
                            person.removeHate(toggleButton3.getText().toString());
                        }
                        break;
                    case R.id.japanese:
                        if (toggleButton4.isChecked()) {
                            person.addHate(toggleButton4.getText().toString());
                        } else {
                            person.removeHate(toggleButton4.getText().toString());
                        }
                        break;
                    case R.id.bunsik:
                        if (toggleButton5.isChecked()) {
                            person.addHate(toggleButton5.getText().toString());
                        } else {
                            person.removeHate(toggleButton5.getText().toString());
                        }
                        break;
                    case R.id.fastfood:
                        if (toggleButton6.isChecked()) {
                            person.addHate(toggleButton6.getText().toString());
                        } else {
                            person.removeHate(toggleButton6.getText().toString());
                        }
                        break;
                }
